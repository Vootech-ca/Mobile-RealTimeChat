...
class _ConnectionLostPageState extends State<ConnectionLostPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return  SafeArea(
      child: Scaffold(appBar: AppBar(title: Text("Change password"),backgroundColor: Colors.white,),
        body: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text("No internet connection, check the connection to your network",
                  textAlign: TextAlign.center,
                  style:
